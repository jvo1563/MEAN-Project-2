...
export class HttpService {
  ...
  createReport(new_report:Report): Observable<HttpResponse<any>>{
    let response =  this.httpClient.post<any>(this.aws_gw_true_url + this.private_report_endpoint, 
      {
        title: new_report.title,
        description: new_report.description,
        location: new_report.location,
  ...
  getAllReports(): Observable<HttpResponse<any>>{
    ...
    return this.httpClient.get<any>(this.aws_gw_true_url+this.private_report_endpoint, {observe: 'response'});
  }

  getReportById( report_id: number): Observable<HttpResponse<any>>{
    return this.httpClient.get<any>(this.aws_gw_true_url+this.private_report_endpoint+`/${report_id}`, {observe: 'response'});
  }

  getReportsByAssignedId(user_id: number): Observable<HttpResponse<any>>{
    return this.httpClient.get<any>(this.aws_gw_true_url+this.private_report_endpoint+`/assigned_to/${user_id}`, {observe: 'response'});
  }

  updateReport(report_id:number,diff_report:Report): Observable<HttpResponse<any>>{
    
    return this.httpClient.put<any>(this.aws_gw_true_url + this.private_report_endpoint + `/${report_id}`, 
      {
  ...
  deleteReport(report_id: number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_report_endpoint+`/${report_id}`);
  }
  ...
  createCategory(new_category: {category_name:string, description:string}): Observable<HttpResponse<{id:number, category_name:string, description:string}>>{
    ...
    return this.httpClient.post<{id:number, category_name:string, description:string}>(this.aws_gw_true_url+this.private_category_endpoint, 
      {
  ...
  getAllCategories(): Observable<HttpResponse<{id:number, category_name:string, description:string}[]>>{
    ...
    return this.httpClient.get<{id:number, category_name:string, description:string}[]>(this.aws_gw_true_url+this.private_category_endpoint,
      {observe:'response'}
    );
  }
  ...
  getCategoryById(cat_id:number): Observable<HttpResponse<{id:number, category_name:string, description:string}>>{
    ...
    return this.httpClient.get<{id:number, category_name:string, description:string}>(this.aws_gw_true_url+this.private_category_endpoint + `/${cat_id}`,
      {observe:'response'}
    );
  }
  ...
  updateCategory(cat_id:number, diff_category: {id:number, category_name:string, description:string}): Observable<HttpResponse<{id:number, category_name:string, description:string}>>{
    ...
    return this.httpClient.put<{id:number, category_name:string, description:string}>(this.aws_gw_true_url+this.private_category_endpoint + `/${cat_id}`,
      {
        id:diff_category.id,
  ...
  deleteCategory(cat_id:number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_category_endpoint+`/${cat_id}`);
  }
  ...
  createStatus(new_status: {status_name:string}): Observable<HttpResponse<{id:number, status_name:string}>>{
    return this.httpClient.post<{id:number, status_name:string}>(this.aws_gw_true_url+this.private_status_endpoint, 
      {
  ...
  getAllStatus(): Observable<HttpResponse<{id:number, status_name:string}[]>>{
    return this.httpClient.get<{id:number, status_name:string}[]>(this.aws_gw_true_url+this.private_status_endpoint,
      {observe:'response'}
    );
  }
  ...
  getStatusById(status_id:number): Observable<HttpResponse<{id:number, status_name:string}>>{
    ...
    return this.httpClient.get<{id:number, status_name:string}>(this.aws_gw_true_url+this.private_status_endpoint + `/${status_id}`,
      {observe:'response'}
    );
  }
  ...
  updateStatus(status_id:number, diff_status: {id:number, status_name:string}): Observable<HttpResponse<{id:number, status_name:string}>>{
    ...
    return this.httpClient.put<{id:number, status_name:string}>(this.aws_gw_true_url+this.private_status_endpoint + `/${status_id}`,
      {
        id:diff_status.id,
  ...
  deleteStatus(status_id:number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_status_endpoint+`/${status_id}`);
  }
  ...
  createUser(new_user: UserEntity): Observable<HttpResponse<UserEntity>>{
    ...
    return this.httpClient.post<UserEntity>(this.aws_gw_true_url+this.private_user_endpoint, 
      {
  ...
  getAllUsers(): Observable<HttpResponse<any[]>>{
    ...
    return this.httpClient.get<any[]>(this.aws_gw_true_url+this.private_user_endpoint,
      {observe:'response'}
    );
  }
  ...
  getUserById(user_id:number): Observable<HttpResponse<any>>{
    ...
    return this.httpClient.get<any>(this.aws_gw_true_url+this.private_user_endpoint + `/${user_id}`,
      {observe:'response'}
    );
  }
  ...
  updateUser(user_id:number, diff_user: UserEntity): Observable<HttpResponse<any>>{
    ...
    return this.httpClient.put<any>(this.aws_gw_true_url+this.private_user_endpoint + `/${user_id}`,
      {
        id: diff_user.id,
  ...
  deleteUser(user_id:number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_user_endpoint+`/${user_id}`);
  }
  ...
  createBuisness(new_buisness: BuisnessEntity): Observable<HttpResponse<any>>{
    ...
    return this.httpClient.post<any>(this.aws_gw_true_url+this.private_buisness_endpoint, 
      {
        report_id:new_buisness.report_id,
        name:new_buisness.name,
        industry: new_buisness.industry,
  ...
  getAllBuisnesss(): Observable<HttpResponse<BuisnessEntity[]>>{
    ...
    return this.httpClient.get<BuisnessEntity[]>(this.aws_gw_true_url+this.private_buisness_endpoint,
      {observe:'response'}
    );
  }
  ...
  getBuisnessById(buisness_id:number): Observable<HttpResponse<BuisnessEntity>>{
    ...
    return this.httpClient.get<BuisnessEntity>(this.aws_gw_true_url+this.private_buisness_endpoint + `/${buisness_id}`,
      {observe:'response'}
    );
  }
  ...
  updateBuisness(buisness_id:number, diff_buisness: BuisnessEntity): Observable<HttpResponse<any>>{
    ...
    return this.httpClient.put<any>(this.aws_gw_true_url+this.private_buisness_endpoint + `/${buisness_id}`,
      {
        id: diff_buisness.id,
  ...
  deleteBuisness(buisness_id:number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_buisness_endpoint+`/${buisness_id}`);
  }
  ...
  createAnnotation(new_annotation: Annotation): Observable<HttpResponse<Annotation>>{
    ...
    return this.httpClient.post<Annotation>(this.aws_gw_true_url+this.private_annotation_endpoint, 
      {
  ...
  getAllAnnotations(): Observable<HttpResponse<Annotation[]>>{
    ...
    return this.httpClient.get<Annotation[]>(this.aws_gw_true_url+this.private_annotation_endpoint,
      {observe:'response'}
    );
  }
  ...
  getAnnotationById(annotation_id:number): Observable<HttpResponse<Annotation>>{
    ...
    return this.httpClient.get<Annotation>(this.aws_gw_true_url+this.private_annotation_endpoint + `/${annotation_id}`,
      {observe:'response'}
    );
  }
  ...
  updateAnnotation(annotation_id:number, diff_annotation: Annotation): Observable<HttpResponse<Annotation>>{
    ...
    return this.httpClient.put<Annotation>(this.aws_gw_true_url+this.private_annotation_endpoint + `/${annotation_id}`,
      {
  ...
  deleteAnnotation(annotation_id:number):Observable<void>{
    ...
    return this.httpClient.delete<void>(this.aws_gw_true_url+this.private_annotation_endpoint+`/${annotation_id}`);
  }
}
